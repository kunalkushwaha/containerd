...
func SnapshotterSuite(t *testing.T, name string, snapshotterFn func(root string) (Snapshotter, func(), error)) {
	...
	t.Run("StatActive", makeTest(t, name, snapshotterFn, testSnapshotterStatActive))
	t.Run("StatCommited", makeTest(t, name, snapshotterFn, testSnapshotterStatActive))
	t.Run("StatCommited", makeTest(t, name, snapshotterFn, testSnapshotterSameKeyPrepareView))
